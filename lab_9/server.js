...
app.get('/home/pick_color', function(req, res) {
	...
	var color_message = `SELECT color_msg FROM favorite_colors WHERE('${color_choice}' = hex_value);`; // Write a SQL query to retrieve the color message for the selected color
...
app.get('/team_stats', function(req, res) {
	var query1 = `select *, (case when home_score > visitor_score then 'CU Boulder' else visitor_name end) as winner from football_games order by game_date;`;
